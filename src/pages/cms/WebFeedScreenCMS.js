...
class WebFeedScreenCMS extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
          ...
          <div class="col-12 col-xl-12">
            <section class="section Transactions_table">
              <div class="card" style={{backgroundColor: "#f8f9fa"}}>
                <div class="card-header"> Feed Screen</div>
          ...
          <Card className="shadow">
            <CardHeader className="bg-secondary">
              <div className="clearfix">
                <h2 className="mb-0 float-left">Feed Screen</h2>
              </div>
            </CardHeader>
            <CardBody>
              {loading ? this.showLoader() : this.renderForm()}
...
export default connect(mapStateToProps)(WebFeedScreenCMS);
