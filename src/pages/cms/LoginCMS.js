...
class LoginCMS extends Component {
  ...
  renderForm = () => {
    const { form, errors, imagePreview, isUploading, uploadProgress } =
      this.state;
...
{/* <div class="col-12 col-sm-12">
														<div class="form-group has-icon-left">
															...
															<div class="position-relative">
																<input type="password" class="form-control" placeholder=" " id="password-id-icon">
          ...
          <div class="col-12 col-xl-12">
            <section class="section Transactions_table">
              <div class="card" style={{backgroundColor: "#f8f9fa"}}>
                <div class="card-header"> Login Screen</div>
          ...
          <Card className="shadow">
            <CardHeader className="bg-secondary">
              <div className="clearfix">
                <h2 className="mb-0 float-left">Login Screen</h2>
              </div>
            </CardHeader>
            <CardBody>
              {loading ? this.showLoader() : this.renderForm()}
...
export default connect(mapStateToProps)(LoginCMS);
